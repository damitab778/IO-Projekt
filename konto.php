...
<br><br><input type="button" value="Edytuj informacje o dzieciach" id="klawisz" onClick="document.getElementById('ukryty').style.display='block';">
<div id="dane"></div>
...
<td><br><input type="button" value="anuluj" id="klawisz" onClick="document.getElementById('ukryty').style.display='none';"></td>
</tr>
</table>
</form>
</div>
